...
def seed_test_canonical_objects(
    *,
    ...
    admin_objects = [
        ...
        {
            "id": "TEST_ADMIN_UNSCHEDULED_OLD",
            "type": "admin",
            "title": "Sort paper receipts",
            "status": "open",
            "next_action": "Group receipts by month",
            "priority": "low",
            "created_at": _dt_iso(old),
            "updated_at": _dt_iso(reference - timedelta(days=8)),
            "tags": ["seed-test", "unscheduled"],
            "source_event_ids": seed_source_ids,
        },
        {
            "id": "TEST_ADMIN_UNSCHEDULED_NEW",
            "type": "admin",
            "title": "Clean out downloads folder",
            "status": "open",
            "next_action": "Archive installers and delete old exports",
            "blocked_reason": "Waiting on external drive cleanup",
            "priority": "normal",
            "created_at": _dt_iso(reference - timedelta(days=4)),
            "updated_at": _dt_iso(reference - timedelta(days=1)),
            "tags": ["seed-test", "unscheduled", "blocked"],
            "source_event_ids": seed_source_ids,
        },
        {
        ...
        {
            "id": "TEST_ADMIN_DUE_AT_OVERDUE",
            "type": "admin",
            "title": "Pay electric bill",
            "status": "open",
            "next_action": "Submit payment before late fee applies",
            "due_at": _dt_iso(reference - timedelta(hours=1)),
            "priority": "high",
            "created_at": _dt_iso(earlier),
            "updated_at": _dt_iso(reference - timedelta(hours=2)),
            "tags": ["seed-test", "timed", "overdue"],
            "source_event_ids": seed_source_ids,
        },
        {
